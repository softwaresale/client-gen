...
// ComputeConfigLocation provides a mock function with given fields: config
func (_m *MockCompilerOutputsManager) ComputeConfigLocation(config types.APIConfig) (outputs.CompilerOutputLocation, error) {
	ret := _m.Called(config)

	if len(ret) == 0 {
		panic("no return value specified for ComputeConfigLocation")
	}

	var r0 outputs.CompilerOutputLocation
	var r1 error
	if rf, ok := ret.Get(0).(func(types.APIConfig) (outputs.CompilerOutputLocation, error)); ok {
		return rf(config)
	}
	if rf, ok := ret.Get(0).(func(types.APIConfig) outputs.CompilerOutputLocation); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(types.APIConfig) error); ok {
		r1 = rf(config)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateConfigOutput provides a mock function with given fields: config
func (_m *MockCompilerOutputsManager) CreateConfigOutput(config types.APIConfig) (outputs.CompilerOutputWriter, error) {
	ret := _m.Called(config)

	if len(ret) == 0 {
		panic("no return value specified for CreateConfigOutput")
	}

	var r0 outputs.CompilerOutputWriter
	var r1 error
	if rf, ok := ret.Get(0).(func(types.APIConfig) (outputs.CompilerOutputWriter, error)); ok {
		return rf(config)
	}
	if rf, ok := ret.Get(0).(func(types.APIConfig) outputs.CompilerOutputWriter); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
